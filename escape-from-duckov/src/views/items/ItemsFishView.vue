        ...
        <div class="container">
            ...
            <div class="table-container">
                <table class="items-table">
                    ...
                    <tbody>
                        <tr v-for="item in CatchItems" :key="item.id" @click="onRowClick(item)"
            ...
            <div class="table-container">
                <table class="items-table">
                    ...
                    <tbody>
                        <tr v-for="item in FishingRodItems" :key="item.id" @click="onRowClick(item)"
                            :class="['item-row', { 'disabled': item.showDetail === false }]">
                            <td class="image-cell">
                                <div class="avatar"><img :src="item.imageUrl" :alt="item.imageAlt" class="image"></div>
                            </td>
            ...
            <div class="table-container">
                <table class="items-table">
                    ...
                    <tbody>
                        <tr v-for="item in FishBaitItems" :key="item.id" @click="onRowClick(item)"
                            :class="['item-row', { 'disabled': item.showDetail === false }]">
                            <td class="image-cell">
                                <div class="avatar"><img :src="item.imageUrl" :alt="item.imageAlt" class="image"></div>
                            </td>
            ...
            <h2 class="group-title">Other Fishing Gear</h2>
            <div class="table-container">
                <table class="items-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr v-for="item in FishingGearItems" :key="item.id" @click="onRowClick(item)"
                            :class="['item-row', { 'disabled': item.showDetail === false }]">
                            <td class="image-cell">
                                <div class="avatar"><img :src="item.imageUrl" :alt="item.imageAlt" class="image"></div>
                            </td>
...
const CatchItems = computed(() => (itemsData?.value || []).filter(i => i.type === 'catch'))
const FishingRodItems = computed(() => (itemsData?.value || []).filter(i => i.type === 'fishing rod'))
const FishBaitItems = computed(() => (itemsData?.value || []).filter(i => i.type === 'fish bait'))

        ...
        <section class="detail-header-section">
            <div class="container">
                <div class="breadcrumb">
                    ...
                    <a :href="getLocalizedPathForCurrentLang(`/items/${category}`)" class="breadcrumb-link">{{
                        categoryTitle }}</a>
                    <svg class="breadcrumb-arrow" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        stroke-width="2">
                        <polyline points="9,18 15,12 9,6" />
                ...
                <div class="content-layout">
                    ...
                    <div class="right-sidebar" v-if="item">
                        ...
                        <div class="nav-box" v-if="otherItems.length">
                            ...
                            <div class="nav-links">
                                <a v-for="it in otherItems" :key="it.id"
                                    :href="getLocalizedPathForCurrentLang(`/items/${category}/${(it.addressBar || '').replace('/', '')}`)"
                                    class="nav-link">{{ it.title }}</a>
                            </div>
                        </div>
                    </div>
                </div>
...
.tag {
    ...
    color: #FA9317;
    border: 1px solid rgba(250, 147, 23, 0.35);
}

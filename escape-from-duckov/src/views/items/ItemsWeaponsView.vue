    ...
    <div class="items-category-view">
        <div class="container">
            <div class="page-header">
                ...
                <p class="page-subtitle">Browse Weapons list.</p>
            </div>
            ...
            <div class="table-container">
                <table class="items-table">
                    ...
                    <tbody>
                        <tr v-for="item in meleeItems" :key="item.id" @click="onRowClick(item)"
            ...
            <div class="table-container">
                <table class="items-table">
                    ...
                    <tbody>
                        <tr v-for="item in rangedItems" :key="item.id" @click="onRowClick(item)"
                            :class="['item-row', { 'disabled': item.showDetail === false }]">
                            <td class="image-cell">
                                <div class="avatar"><img :src="item.imageUrl" :alt="item.imageAlt" class="image"></div>
                            </td>
...
const isMelee = (t) => {
    ...
    return s.includes('melee') || s.includes('knife') || s.includes('blade')
}

const meleeItems = computed(() => (itemsData?.value || []).filter(i => isMelee(i.type)))

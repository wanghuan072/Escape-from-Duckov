export const guides = [
  ...
  {
    "id": 12,
    "title": "《逃离达科夫》攻略第一部分：越狱与基地设置",
    "description": "您的《逃离达科夫》入门必备指南！涵盖完整的越狱教程、基地基础设施设置以及完成 Ground Zero 的初始任务。",
    "imageUrl": "/images/guide12.webp",
    "imageAlt": "玩家角色在《逃离达科夫》越狱过程中搜刮箱子。",
    ...
    "seo": {
      "title": "《逃离达科夫》第一部分指南：监狱、基地设置和初始任务",
  ...
          <h2>基地：基础设施和初始增强</h2>
          <p>返回基地后，找到楼上的 **杰夫（Jeff）** 进行参观：仓库、建造面板、自动售货机、增强器和撤离点。</p>
  ...
              <li>在森林小径附近，找到一个小营地，里面有 **MD40 的配方**。使用铲子**挖出 J-Lab 软盘**。</li>
  ...
  {
    "id": 13,
    "title": "《逃离达科夫》攻略第二部分：Ground Zero 探索与基地扩张",
    "description": "《逃离达科夫》第二部分必备指南。完成信号塔任务，解锁洞穴，击败强力守卫，并通过新的商店扩张您的基地。",
    "imageUrl": "/images/guide13.webp",
    "imageAlt": "玩家角色在《逃离达科夫》的 Ground Zero 地图上修理一座破损的桥梁。",
    "publishDate": "2025-11-03",
  ...
  {
    "id": 14,
    "title": "《逃离达科夫》攻略第三部分：Ground Zero 钥匙与 Pato Chapo Boss",
    "description": "《逃离达科夫》第三部分的综合指南。接受新的商人任务，建造医疗站和武器店，并找到 Pato Chapo Boss。",
    "imageUrl": "/images/guide14.webp",
    "imageAlt": "玩家角色在《逃离达科夫》的 Ground Zero 中用钥匙打开一扇锁着的门。",
    "publishDate": "2025-11-03",
  ...
  {
    "id": 15,
    "title": "《逃离达科夫》攻略第四部分：鸭母 Boss 与 AS VAL",
    "description": "《逃离达科夫》第四部分的完整指南。接受新的地堡任务，击败强大的鸭母 Boss，并获得强大的 AS VAL 武器。",
    "imageUrl": "/images/guide15.webp",
    "imageAlt": "玩家角色在《逃离达科夫》的废弃营地位置与大型 Boss 鸭母战斗。",
    "publishDate": "2025-11-03",
  ...
  {
    "id": 16,
    "title": "《逃离达科夫》攻略第五部分：循环重复 - 鸭母返场",
    "description": "《逃离达科夫》第五部分的指南。接受高回报的重复任务，最大化核心生存技能，再次击败鸭母 Boss，并获得高级战利品。",
    "imageUrl": "/images/guide16.webp",
    "imageAlt": "玩家角色在《逃离达科夫》废弃营地的一个黑暗房间里使用 AS VAL。",
    "publishDate": "2025-11-03",
    ...
    "seo": {
      "title": "《逃离达科夫》第五部分指南：最大化核心技能和鸭母重复跑图",
  ...
  {
    "id": 6,
    "title": "《逃离鸭科夫》LEDX 获取指南（更新）",
    "description": "正在寻找《逃离鸭科夫》中难以捉摸的 LEDX 吗？本指南将详细介绍最佳获取方法，涵盖刷新位置、钥匙使用、敌人掉落和市场价值。最大化您找到这一关键医疗物品的机会，并发现明智的交易技巧！",
    "tags": [
      "逃离鸭科夫",
      "LEDX",
      "稀有物品",
    ...
    "imageAlt": "《逃离鸭科夫》中显示在工作台上的 LEDX 皮肤透光仪。",
    "category": "advanced",
    "isHome": false,
    "seo": {
      "title": "《逃离鸭科夫》LEDX：终极获取指南",
      "description": "了解如何在《逃离鸭科夫》中找到稀有物品 LEDX。获取关于刷新位置、钥匙需求、交易策略和任务影响的提示，以最大化利润！",
      "keywords": "逃离鸭科夫, ledx, 战利品指南, 疗养院, 钥匙, 稀有物品, 交易, 任务"
    },
    "addressBar": "/escape-from-duckov-ledx",
    "detailsHtml": `
      <p><em>一份寻找和使用 LEDX 的高效指南</em></p>
      <p>在 *《逃离鸭科夫》* 中找到 **LEDX 皮肤透光仪（LEDX Skin Transilluminator）** 是升级您的藏身处（hideout）和推进游戏的关键目标。这件稀有物品不仅因其市场价格而有价值，而且对于重要的任务和藏身处升级至关重要。知道在哪里寻找以及为何保存它可以让您的搜索更加高效。</p>
  
      <h2>**什么是 LEDX？- 概述**</h2>
      <ul>
          <li>**用途：** 用于使血管可见，便于注射。</li>
          <li>**重量：** 0.2kg</li>
          <li>**物品类型：** 医疗</li>
          <li>**物品编号：** "#331"</li>
      </ul>
      ...
      <h2>**核心用途：LEDX 为何如此重要？**</h2>
      <p>在考虑出售这件高价值物品之前，请了解它在游戏中的两个关键用途。 **在战局中找到的（found-in-raid）** LEDX 是您游戏进程中的一个重要里程碑。</p>
  
      <h3>**1. 治疗师任务: "私人诊所"（"Private Clinic"）**</h3>
      <p>在 35 级时，治疗师将提供此任务，要求您上交一个 **在战局中找到的 LEDX** 和一个检眼镜（ophthalmoscope）。奖励是一个非常有价值的 **物品箱（Item Case）**，它提供了大量的存储空间，是管理您仓库（stash）的关键。</p>
  
      <h3>**2. 藏身处升级: 医疗站 3 级**</h3>
      <p>将您藏身处的医疗站（Medstation）升级到最高级别（3 级）需要 **一个 LEDX**。这项升级至关重要，因为它能提升您的整体 **治疗效率** 并解锁更多高级医疗物品的制作配方。</p>
  
      <h2>**在哪里找到 LEDX - 最佳地点**</h2>
      <p>虽然 LEDX 理论上可以在许多高级医疗战利品位置刷新，但有些地点比其他地方可靠得多。将您的精力集中在这些区域，以最大化您的机会。</p>
      ...
      <table>
          ...
          <tbody>
              <tr>
                  <td>**农场镇药店 (Farmtown Pharmacies)**</td>
                  <td>货架、桌子、医疗包</td>
                  <td>被认为是最可靠和最稳定的 LEDX 刷新点之一。</td>
              </tr>
              <tr>
                  <td>**USEC 营地 (Woods)**</td>
                  <td>担架、尸体、医疗包</td>
                  <td>LEDX 刷新率非常高，使其成为主要的刷宝点。</td>
              </tr>
              <tr>
                  <td>**实验室区域 (Lab Areas)**</td>
                  <td>医疗推车、货架、金属罐</td>
                  <td>高风险、高回报。需要钥匙和谨慎的导航。</td>
              </tr>
          </tbody>
      </table>
      ...
      <p>
          **地点 1: 前往农场镇药店**
          <br>进入商业区并找到两家药店。系统地检查每个货架、桌子和散落的医疗包以寻找 LEDX。
      </p>
      <p>
          **地点 2: 访问 Woods 地图上的 USEC 营地**
          <br>前往 USEC 营地区域，搜索担架、尸体和医疗容器。这里是所有类型有价值医疗战利品的聚集地。
      </p>
      <p>
          **地点 3: 探索实验室区域**
          <br>这是一个高风险的选择。使用钥匙解锁医疗室的门（例如在疗养院 Sanatorium），并检查医疗推车、货架和金属罐。战利品密度很高，但危险也很大。
      </p>
      <p><img src="/images/guide/guide06-02.webp" alt="LEDX2" width="50%" style="width: 50%;"></p>
  
      <h2>**价值和交易建议**</h2>
      <p>LEDX 在跳蚤市场（Flea Market）上售价非常高（通常为 **16,250 港币**或更高），这使得立即出售非常诱人。然而，这通常是一个错误。</p>
      
      <p>**强烈建议：不要急于出售它！**</p>
      <ul>
          <li>**至少保留两个：** 您需要一个用于医疗站升级，另一个用于“私人诊所”任务。在出售任何多余物品之前，请确保您已满足这些需求。</li>
          <li>**玩家经验证实了这一点：** 正如玩家经常建议的那样：“你以后会需要 3 个来做任务”，以及“你以后会用它们来制作重要的物品。请确保保留一些。”优先考虑您的游戏进程而非短期利润。</li>
      </ul>
  
      <h2>**总结**</h2>
      <p>LEDX 是一种具有重要经济和战略价值的稀有物品。通过了解它在任务和藏身处的核心用途，并将您的搜索集中在像 **农场镇药店、Woods USEC 营地和实验室** 这样可靠的地点，您可以有效地获取这一关键物品，并在 *《逃离鸭科夫》* 中推进您的进程。祝您好运找到您的“小黄鸭”！</p>
      `
  },
  ...
  <p><strong>注意：</strong> 与典型的钥匙物品不同，这些卡是**消耗品**；每次进入实验室时都会消耗一张。</p>
  ...
  {
    "id": 18,
    "title": "《逃离达科夫》：扩张板条箱终极指南",
    "description": "《逃离达科夫》中仓库空间不足？本指南将揭示扩张板条箱的秘密，这是永久存储升级的关键！了解最佳刷取路线、重要提示和板条箱位置，以最大化您的战利品并称霸游戏。立即扩展您的保险库！",
    "tags": [
      "Escape From Duckov",
      "Expansion Crates",
      "Loot Management",
    ...
    "imageAlt": "玩家在《逃离达科夫》中搜刮一个扩张板条箱，强调仓库管理的重要性。",
    "category": "advanced",
    "seo": {
      "title": "《逃离达科夫》扩张板条箱 - 终极存储指南",
  ...
  <p>扩张板条箱是用于升级藏身处仓库大小的稀有物品。虽然所有存储升级都需要不同的材料，但扩张板条箱是其中最重要的组成部分之一。</p>
  ...
  <p>许多新玩家第一次找到扩张箱时会感到困惑，因为它不能像普通物品一样被“打开”或“使用”。请记住这个关键规则：**小型扩张箱 S 是一种保险库升级材料，而不是消耗品。** 它只有在您应用特定的保险库升级时才会被消耗。</p>
  ...
  <h2><strong>仓库容量与背包容量：关键区别</strong></h2>
  <p>重要的是要了解，扩张箱**只增加您在藏身处的仓库容量。** 它们不会增加您的任务配置槽位，也不会增加您在突袭中的背包大小。</p>
  ...
  {
    "id": 19,
    "title": "《逃离达科夫》：青铜怀表任务完全指南",
    "description": "穿越《逃离达科夫》的险恶地带，以获取青铜怀表！这份综合指南提供了分步说明，从获取机械钥匙到安全撤离您的奖品。掌握游戏的核心机制并向泽维尔（Xavier）领取您的奖励。",
    "tags": [
      "Escape From Duckov",
      "Bronze Pocket Watch",
      "Quest Guide",
    ...
    "imageAlt": "玩家角色在《逃离达科夫》中从一辆卡车上搜刮青铜怀表。",
    "category": "advanced",
    "seo": {
      "title": "《逃离达科夫》：青铜怀表任务 - 完整攻略",
  ...
  <h2><strong>第 2 步：在 Ground Zero 上找到青铜怀表的位置</strong></h2>
  <p>青铜怀表位于一个固定位置：一辆**连接着橙色油罐车的白色卡车**的驾驶室内部。您会在 **Ground Zero 的东南角**找到这辆卡车，它停在河对岸一堆被遗弃的车辆堆中。</p>
  <p>最容易导航的地标是**下水道出口**。卡车就位于该出口以东不远的地方。</p>
  ...
  <p>成功带着青铜怀表撤离后，返回地堡。与**泽维尔**交谈并交出怀表以完成任务。</p>
  <p>完成此任务将奖励您 XP 和货币，并解锁他故事情节中的下一个任务，即**“货物清单”**。</p>

export const guides = [
...

  {
    ...
    detailsHtml: `
    <p><em>An Efficient Guide to Finding and Using the LEDX</em></p>
    <p>Finding the **LEDX Skin Transilluminator** in *Escape from Duckov* is a key objective for upgrading your hideout and progressing through the game. This rare item is not just valuable for its market price but is essential for crucial quests and hideout upgrades. Knowing where to look and what to save it for can make your search much more efficient.</p>

    <h2>**What is a LEDX? - An Overview**</h2>
    <ul>
        <li>**Purpose:** Used to make blood vessels visible for easy injection.</li>
        <li>**Weight:** 0.2kg</li>
        <li>**Item Type:** Medic</li>
        <li>**Item Number:** "#331"</li>
    </ul>
    <p><img src="/images/guide/guide06-01.webp" alt="LEDX-1"></p>

    <h2>**Core Uses: Why is the LEDX So Important?**</h2>
    <p>Before you consider selling this high-value item, understand its two critical uses in the game. A **found-in-raid** LEDX is a major milestone in your progression.</p>

    <h3>**1. Therapist Quest: "Private Clinic"**</h3>
    <p>At level 35, the Therapist will offer this quest, requiring you to turn in a **found-in-raid LEDX** alongside an ophthalmoscope. The reward is a highly valuable **Item Case**, which provides a massive amount of storage space and is a game-changer for managing your stash.</p>

    <h3>**2. Hideout Upgrade: Medstation Level 3**</h3>
    <p>Upgrading your hideout’s Medstation to its maximum level (Level 3) requires **one LEDX**. This upgrade is essential, as it boosts your overall **healing effectiveness** and unlocks more crafting recipes for advanced medical items.</p>

    <h2>**Where to Find LEDX - Top Locations**</h2>
    <p>While a LEDX can theoretically spawn in many high-tier medical loot locations, some spots are far more reliable than others. Focus your efforts on these areas to maximize your chances.</p>

    <table>
        <thead>
            <tr>
                <th>Location</th>
                <th>Common Spawn Points</th>
                <th>Notes</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                <td>Shelves, tables, medical bags</td>
                <td>Considered one of the most reliable and consistent LEDX spawns.</td>
            </tr>
            <tr>
                <td>**USEC Camp (Woods)**</td>
                <td>Stretchers, bodies, medical bags</td>
                <td>A very high LEDX spawn rate, making it a prime farming spot.</td>
            </tr>
            <tr>
                <td>**Lab Areas**</td>
                <td>Medical carts, shelves, metal tins</td>
                <td>High risk, high reward. Requires keys and careful navigation.</td>
            </tr>
        </tbody>
    </table>

    <h3>**How to Acquire LEDX Efficiently**</h3>
    <p>
        **Place 1: Head to Farmtown Pharmacies**
        <br>Enter the commercial district and locate the two pharmacies. Systematically check every shelf, table, and loose medical bag for the LEDX.
    </p>
    <p>
        **Place 2: Visit the USEC Camp on the Woods Map**
        <br>Go to the USEC camp area and search the stretchers, bodies, and medical containers. This is a hotspot for all types of valuable medical loot.
    </p>
    <p>
        **Place 3: Explore Lab Areas**
        <br>This is a high-risk option. Use keys to unlock doors to medical rooms (e.g., in the Sanatorium) and check medical carts, shelves, and metal tins. The loot density is high, but so is the danger.
    </p>
    <p><img src="/images/guide/guide06-02.webp" alt="LEDX2" width="50%" style="width: 50%;"></p>

    <h2>**Value and Trading Recommendations**</h2>
    <p>A LEDX sells for a very high price on the Flea Market (often **16,250 HKD** or more), making it tempting to sell immediately. However, this is usually a mistake.</p>
    
    <p>**Strong Recommendation: Do NOT rush to sell it!**</p>
    <ul>
        <li>**Save at least two:** You will need one for the Medstation upgrade and another for the "Private Clinic" quest. Make sure you have these covered before selling any extras.</li>
        <li>**Player experience confirms this:** As players often advise, "You will need 3 for later tasks," and "You will use these to craft important items later. Make sure to keep some." Prioritize your progression over short-term profit.</li>
    </ul>

    <h2>**Summary**</h2>
    <p>The LEDX is a rare item with significant economic and strategic value. By understanding its core uses for quests and your hideout, and by focusing your searches on reliable locations like the **Farmtown Pharmacies, Woods USEC Camp, and the Lab**, you can efficiently secure this vital item and advance your progress in *Escape from Duckov*. Good luck finding your "yellow duck"!</p>
    `
  },
...
<p>Here's a brief description of each card type:</p>
